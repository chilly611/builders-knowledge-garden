        ...
        post: {
          ...
          requestBody: {
            ...
            content: { "application/json": { schema: { type: "object", required: ["tool"], properties: {
              tool: { type: "string", enum: ["lookup_code","search_knowledge","get_material","get_safety","estimate_cost","get_permits","generate_schedule","get_team","list_building_types","list_jurisdictions"] },
