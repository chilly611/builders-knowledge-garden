...
const DREAM_PATHS: DreamPath[] = [
  { id: "describe", route: "/dream/describe", icon: "✦", name: "Describe Your Dream",
    ...
    color: "#E8A83E", image: "url(https://replicate.delivery/xezq/qJdE9hz1q27JNNUG7LbXeCJlfk3eFd4IE6n8jtXwBHJpnutsA/tmp5a1fyw4t.webp)",
  ...
  { id: "inspire", route: "/dream/inspire", icon: "◈", name: "Show Me Inspiration",
    ...
    color: "#D85A30", image: "url(https://replicate.delivery/xezq/JI5VpjAFVrKAIVlkYtLa4wvNpR58JLLWAxo5d1WRytpF1tlF/tmp44c6dana.webp)",
  ...
  { id: "sketch", route: "/dream/sketch", icon: "△", name: "Sketch It Out",
    ...
    color: "#C4A44A", image: "url(https://replicate.delivery/xezq/3Yf96MXbzQxFCaDMMwuZ3TTEJfavHT8NwpfQWqxc7ihzputsA/tmpjq_wt3_7.webp)",
  ...
  { id: "explore", route: "/dream/explore", icon: "⬡", name: "Surprise Me",
    ...
    color: "#E07B3A", image: "url(https://replicate.delivery/xezq/T0dqygzQ5zoNItm8fQDAf74c9YZOb6GbrnhkWZUZMPmcV3WWA/tmplmmcxsw5.webp)",
  ...
  { id: "browse", route: "/dream/browse", icon: "◉", name: "Browse & Discover",
    ...
    color: "#B8873B", image: "url(https://replicate.delivery/xezq/1oTIgZRjZNJeFyYNtkCL1KIf5iXoGhyPT0yelhFfbc97XdbZB/tmpm3m4bo20.webp)",
  ...
  { id: "plans", route: "/dream/plans", icon: "⊞", name: "I Have Plans",
    ...
    color: "#9C7832", image: "url(https://replicate.delivery/xezq/U38Y3cYYd6pdI5SUXEfJsLQrVUWgfr5ZofJqH5jeXJ5ObdbZB/tmpni7op1ls.webp)",
  ...
  { id: "oracle", route: "/dream/oracle", icon: "🔮", name: "The Oracle",
    ...
    color: "#D85A30", image: "url(https://replicate.delivery/xezq/Q6ffebV0tlOrJpftNfOAzv5LimyjuZpFXNfUiF4Q1ttWg1tlF/tmptjpeqt3v.webp)",
  ...
  { id: "alchemist", route: "/dream/alchemist", icon: "⚗️", name: "The Alchemist",
    ...
    color: "#C4A44A", image: "url(https://replicate.delivery/xezq/qg6meqkzWV15dKLHoPoaJ24NQsJPgkCSsf0C8e2R0OsJsutsA/tmpbw2a0w54.webp)",
  ...
  { id: "quest", route: "/dream/quest", icon: "⚔️", name: "The Quest",
    ...
    color: "#E07B3A", image: "url(https://replicate.delivery/xezq/7xXcY2Q9agI7NBE26NEI6vJPD0nN9OyY9kwhqjVeXOwErbLLA/tmpl0aa03t8.webp)",
  ...
  { id: "genome", route: "/dream/genome", icon: "🧬", name: "The Genome",
    ...
    color: "#1D9E75", image: "url(https://replicate.delivery/xezq/jZRQbH4XUdL6C94ch1er1931BJ50lHClruEeBDbZeEf7YdbZB/tmp05g9et6a.webp)",
  ...
  { id: "cosmos", route: "/dream/cosmos", icon: "🌌", name: "The Cosmos",
    ...
    color: "#1D9E75", image: "url(https://replicate.delivery/xezq/lHIbFWyEcIoxD59aeRWXlxwUoqH999hAFHZVDlabedVYW3WWA/tmpapyr4dcu.webp)",
  ...
  { id: "narrator", route: "/dream/narrator", icon: "📖", name: "The Narrator",
    ...
    color: "#B8873B", image: "url(https://replicate.delivery/xezq/eqeSKzoOfhIZ7Jt58i1NjRaKuKX5lCpNuwj3o3LMZ4M2sutsA/tmpbdla2ntw.webp)",
  ...
  { id: "collider", route: "/dream/collider", icon: "⚡", name: "The Collider",
    ...
    color: "#E8443A", image: "url(https://replicate.delivery/xezq/IDDoqWEtwTaPCltWXJjrQ9xuHd9gADq0MGSmjJw172Lo1tlF/tmpkuwmp17a.webp)",
  ...
  { id: "sandbox", route: "/dream/sandbox", icon: "🧱", name: "The Sandbox",
    ...
    color: "#E07B3A", image: "url(https://replicate.delivery/xezq/xDnqiERZepUVRKGeJnNtWeeaCYMHbhSHyqwfcs27bCj3062yC/tmpv6dwiwda.webp)",
  ...
  { id: "voice", route: "/dream/voice", icon: "🎙️", name: "The Voice Architect",
    ...
    color: "#C4A44A", image: "url(https://replicate.delivery/xezq/YeuBOH44kMzRBKuXHTUNBpsDdpyDUpBwkJQNhzvJkdSXrbLLA/tmpmp9phw0o.webp)",
