  ...
  return (
    <>
      <div style={{
        ...
        <h1 className={archivoBlack.className} style={{
        ...
        }} className={archivo.className}>Coming in Chunk 7 — Professional plan upload + knowledge enrichment</div>
        <Link href="/dream" style={{
          color: "#9C7832", textDecoration: "none", fontSize: "0.85rem",
          letterSpacing: "0.1em", opacity: 0.7,
        }} className={archivo.className}>← Back to Dream Machine</Link>
      </div>
      <CopilotPanel />
    </>
  );
