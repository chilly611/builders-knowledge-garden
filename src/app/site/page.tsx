      ...
      <div style={{ paddingTop: 48 }}>
            ...
            <div>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 8 }}>
                ...
                <div>
                  ...
                  <p style={{ margin: '2px 0 0', fontSize: 12, color: '#888' }}>Drone · photos · digital twin · IoT</p>
                </div>
              </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', minHeight: 'calc(100vh - 200px)' }}>
          <div style={{ padding: '24px 28px', borderRight: '1px solid #e5e5e0' }}>
            ...
            {/* Photo grid preview */}
            <h2 style={{ fontSize: 13, fontWeight: 700, color: '#888', textTransform: 'uppercase', letterSpacing: '1px', margin: '0 0 14px' }}>Site Photo Log Preview</h2>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: 10, marginBottom: 24 }}>
              {DEMO_PHOTOS.map((p, i) => (
                <div key={i} style={{ background: '#F5F5F0', border: `1px solid ${p.flag ? 'rgba(245,158,11,0.3)' : '#e5e5e0'}`, borderRadius: 10, overflow: 'hidden' }}>
                  ...
                  <div style={{ padding: '8px 10px' }}>
                    <p style={{ fontSize: 11, fontWeight: 600, color: '#1a1a1a', margin: '0 0 2px' }}>{p.label}</p>
                    <p style={{ fontSize: 10, color: '#999', margin: '0 0 4px' }}>{p.date}</p>
                    {p.progress !== null && (
                      <div>
                        <div style={{ height: 3, background: '#EEEDE8', borderRadius: 2, overflow: 'hidden' }}>
            ...
            <div style={{ background: '#FAFAF8', border: '1px solid rgba(186,117,23,0.2)', borderRadius: 12, padding: '20px', marginBottom: 24, textAlign: 'center' }}>
              <div style={{ fontSize: 48, marginBottom: 8 }}>🌐</div>
              <p style={{ fontSize: 14, fontWeight: 700, color: '#1a1a1a', margin: '0 0 6px' }}>Digital Twin</p>
              <p style={{ fontSize: 12, color: '#888', margin: 0, lineHeight: 1.5, maxWidth: 400, display: 'inline-block' }}>
          ...
          <div style={{ padding: '24px 20px' }}>
            <div style={{ background: 'rgba(186,117,23,0.06)', border: '1px solid rgba(186,117,23,0.15)', borderRadius: 12, padding: '14px', marginBottom: 14 }}>
              ...
              <p style={{ fontSize: 11, color: '#888', margin: 0, lineHeight: 1.5 }}>OpenSpace walks sites and captures 360° photos. Beautiful product. But it doesn't know your schedule, your codes, your punchlist, or what to do about what it finds. We do.</p>
            </div>
