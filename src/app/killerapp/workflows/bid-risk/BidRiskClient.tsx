...
/**
 * BidRiskClient (q1, 2026-05-08 Wave 4 — final batch)
 * ====================================
 *
 * The Should you take this bid? workflow. State persists in
 * command_center_projects.bid_risk_state JSONB.
 *
...
export default function BidRiskClient({ workflow, stages }: Props) {
  const {
  ...
  return (
    <>
      <ProjectContextBanner project={project} selfWorkflow="bid-risk" />
      <WorkflowShell
        workflow={workflow}
        stages={stages}
        breadcrumbLabel="Should you take this bid?"
        contextFields={['lane', 'trade']}
