...
/**
 * ProjectReviewClient (q27, 2026-05-08 Wave 4 — final batch)
 * ====================================
 *
 * The Project Review workflow. State persists in
 * command_center_projects.project_review_state JSONB.
 *
...
export default function ProjectReviewClient({ workflow, stages }: Props) {
  const {
  ...
  return (
    <>
      <ProjectContextBanner project={project} selfWorkflow="project-review" />
      <WorkflowShell
        workflow={workflow}
        stages={stages}
        breadcrumbLabel="Project Review"
        contextFields={['lane']}
