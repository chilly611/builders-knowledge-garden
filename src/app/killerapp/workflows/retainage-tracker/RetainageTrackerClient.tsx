...
/**
 * RetainageTrackerClient (q25, 2026-05-08 Wave 4)
 * ====================================
 *
 * The Retainage Tracker workflow. State persists in
 * command_center_projects.retainage_state JSONB (added in
...
export default function RetainageTrackerClient({ workflow, stages }: Props) {
  const {
  ...
  return (
    <>
      ...
      <WorkflowShell
        workflow={workflow}
        stages={stages}
        breadcrumbLabel="Retainage Tracker"
        contextFields={['lane']}
