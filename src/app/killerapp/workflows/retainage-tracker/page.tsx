...
import RetainageTrackerClient from './RetainageTrackerClient';

const WORKFLOW_ID = 'q25';
...
export const metadata = {
  title: 'Retainage Tracker',
  description: 'Track held-back funds, send reminders, escalate if needed, confirm payment.',
};
...
export default function Page() {
  ...
  return (
    <Suspense fallback={null}>
      <RetainageTrackerClient workflow={workflow} stages={stages} />
    </Suspense>
  );
}
