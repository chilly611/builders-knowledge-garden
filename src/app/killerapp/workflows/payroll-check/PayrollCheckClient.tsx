...
/**
 * PayrollCheckClient (q23, 2026-05-08 Wave 4 — final batch)
 * ====================================
 *
 * The Payroll Classification Check workflow. State persists in
 * command_center_projects.payroll_check_state JSONB.
 *
...
export default function PayrollCheckClient({ workflow, stages }: Props) {
  const {
  ...
  return (
    <>
      <ProjectContextBanner project={project} selfWorkflow="payroll-check" />
      <WorkflowShell
        workflow={workflow}
        stages={stages}
        breadcrumbLabel="Payroll Classification Check"
        contextFields={['lane']}
