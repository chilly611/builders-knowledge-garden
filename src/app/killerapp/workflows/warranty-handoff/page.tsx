...
import WarrantyHandoffClient from './WarrantyHandoffClient';

const WORKFLOW_ID = 'q26';
...
export const metadata = {
  ...
  description: 'Log warranty periods, set reminders, schedule final inspection, file paperwork, generate a handoff summary.',
};
...
export default function Page() {
  ...
  return (
    <Suspense fallback={null}>
      <WarrantyHandoffClient workflow={workflow} stages={stages} />
    </Suspense>
  );
}
