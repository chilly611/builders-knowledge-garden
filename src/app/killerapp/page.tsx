...
import { useGreenFlash, GREEN_FLASH_COLORS } from '@/components/GreenFlashProvider';
...
export default function CommandCenterPage() {
  ...
  const { flashGreen, sustainGreen } = useGreenFlash();
  ...
  const resolveItem = async (id: string) => {
    ...
    flashGreen({ label: 'Issue resolved!', xp: 50 });
  ...
  const handleOnboardingSkip = () => {
    sustainGreen({ label: 'Onboarding complete!', xp: 250, duration: 20000 });
    setOnboardingPhase('done');
  };
