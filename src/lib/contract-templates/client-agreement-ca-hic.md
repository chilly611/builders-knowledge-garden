...
*California Home Improvement Contract — Business & Professions Code § 7159*

**DRAFT — FOR CA-LICENSED ATTORNEY REVIEW BEFORE EXECUTION**
...
**Name:** {{contractorName}}
**Business Address:** {{contractorAddress}}
**CSLB License No.:** {{contractorLicense}}
**Contractor's Bond No.:** {{contractorBond}}
**Phone:** {{contractorPhone}}
**Email (for Notice of Cancellation):** {{contractorEmail}}

> Contractor is required to be bonded for $25,000 minimum per CSLB rules. Bond #: {{contractorBond}}.
...
**Date of this Agreement (date Buyer signed):** {{contractDate}}
...
Any work not described above is excluded from this Agreement unless added through a written Change Order signed by both parties before the changed work begins.

## 2. Contract Price

**Contract Price:** {{contractAmount}}

## 3. Finance Charge

**Finance Charge:** {{financeCharge}}
*(Set out separately from the Contract Price. If none, write "NONE".)*
...
**Substantial Commencement of Work:** Substantial commencement of work occurs when the Contractor has physically delivered materials to the project site or commenced labor on the project site that is integral to performance of the contract.

**Approximate Start Date:** {{startDate}}

## 7. Approximate Completion Date

**Approximate Completion Date:** {{completionDate}}

## 8. List of Documents to be Incorporated into the Contract

{{incorporatedDocuments}}
*(e.g., plans, specifications, allowances, addenda. If none, write "NONE".)*
...
A change order is not enforceable against the Buyer unless the change order also identifies, in writing prior to the commencement of work covered by the new change order: (i) the scope of work encompassed by the order, (ii) the amount to be added or subtracted from the contract, and (iii) the effect the order will have on the progress payments or completion date.
...
*If "Yes":* One or more subcontractors will be used on this project, and the contractor is aware that a list of subcontractors is required to be provided, upon request, along with the names, contact information, license number, and classification of those subcontractors.

**List of Subcontractors (if known):** {{subcontractorList}}

## 11. Commercial General Liability Insurance (CGL)

{{cglNotice}}

*(Use one of the statutorily required statements per Bus. & Prof. Code § 7159(e)(1), e.g., "{{contractorName}} carries commercial general liability insurance written by [insurer]. You may call [insurer] at [phone] to check the contractor's insurance coverage.")*

## 12. Workers' Compensation Insurance

{{workersCompNotice}}

*(Use one of the statutorily required statements per Bus. & Prof. Code § 7159(e)(2).)*

## 13. Right to Require Performance and Payment Bond

The Owner has the right to require the Contractor to have a performance and payment bond.
...
- Call CSLB at **800-321-CSLB (800-321-2752)**
...
- **Phone (for help with the Notice of Cancellation):** {{contractorPhone}}

**Buyer's Acknowledgment of Receipt of Three-Day Right to Cancel:**
...
## Performance and Payment Bond Notice

The Owner or tenant has the right to require the Contractor to have a performance and payment bond.

## Arbitration Notice (Optional)

{{arbitrationNotice}}

*(If the parties agree to binding arbitration, include the arbitration clause and the disclosures required by Code of Civil Procedure §§ 1280 et seq. If not used, write "Arbitration not elected.")*
...
This document is a **starting draft** generated by Builder's Knowledge Garden. It has **not** been reviewed by an attorney. **This is not legal advice. Have a CA-licensed construction attorney review before use.** California Bus. & Prof. Code § 7159 requires specific formatting (typeface sizes, boldface, signature proximity) that this markdown draft approximates but does not guarantee. The final printed contract must comply with all formatting requirements of § 7159(c) and (d).
