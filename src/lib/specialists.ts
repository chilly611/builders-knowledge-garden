...
// TYPES
// ─────────────────────────────────────────────────────────────────────────────
// Garden-engine seam (CODE-2, edge 5): the shapes moved verbatim to the L2
// contract `src/garden/contracts/specialists.ts` so the engine's AnalysisPane
// and this builders runner share ONE definition. Re-exported here so existing
// `@/lib/specialists` type imports keep working unchanged.
...
import type {
  ...
  SupersededNotice,
  SpecialistResult,
} from "@/garden/contracts/specialists";
